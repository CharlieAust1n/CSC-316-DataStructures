...
public class SkipListMap<K extends Comparable<K>, V> extends AbstractOrderedMap<K, V> {
    ...
    public V put(K key, V value) {
    	// Gets the bottom-most entry immediately before the insertion location	
        SkipListNode<K, V> temp = lookUp(key);
    ...
    public V remove(K key) {
        ...
        while(temp != null) {
        	// Updates temp's previous node's next reference to be temp's next reference.
            temp.getPrevious().setNext(temp.getNext());
                
            // Updates temp's next node's previous reference to be temp's previous reference.
    ...
    /**
     * Creates a string of the sorted map.
     * @return String of sorted map.
     */
    ...
    private static class SkipListNode<K, V> {
    	/** Map of entries with values that point to keys */
        private Entry<K, V> entry;
        /** Node reference to its data above. */
        private SkipListNode<K, V> above;
        /** Node reference to its data below. */
        private SkipListNode<K, V> below;
        /** Node reference to its data before. */
        private SkipListNode<K, V> prev;
        /** Node reference to its data after. */
