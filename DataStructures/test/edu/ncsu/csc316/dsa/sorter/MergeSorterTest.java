...
/**
 * Tests the methods of the java class MergeSorter.
 * 
...
public class MergeSorterTest {
	...
	/** Merge sorter used for testing purposes */
	private MergeSorter<Student> normalSorter;
	/** Merge sorter used for testing purposes */
	private MergeSorter<Student> idSorter;
	/** Merge sorter used for testing purposes */
	private MergeSorter<Student> gpaSorter;
	...
	@Before
	public void setUp() {
		normalSorter = new MergeSorter<Student>();
		idSorter = new MergeSorter<Student>(new StudentIDComparator());
		gpaSorter = new MergeSorter<Student>(new StudentGPAComparator());
	}
